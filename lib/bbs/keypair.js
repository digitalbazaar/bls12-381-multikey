...
export function KeyGen({
  key_material, key_info = new Uint8Array(), key_dst, ciphersuite_id
} = {}) {
  ...
  if(key_dst !== undefined) {
    ...
    key_dst = TEXT_ENCODER.encode(ciphersuite_id + 'KEYGEN_DST_');
  }
...
export function SkToPk({SK, ciphersuite_id} = {}) {
