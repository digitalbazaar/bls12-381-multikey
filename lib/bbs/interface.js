 ...
 */
import {CoreSign, CoreVerify, CoreProofGen, CoreProofVerify} from './core.js';
import {
  create_generators,
  messages_to_scalars,
  TEXT_ENCODER
...
function _createApiId(ciphersuite) {
  /*
  ...
  */
  return TEXT_ENCODER.encode(ciphersuite.ciphersuite_id + 'H2G_HM2S_');
}
